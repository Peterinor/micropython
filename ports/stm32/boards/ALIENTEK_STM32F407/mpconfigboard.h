...
// STM32F407ZGT6 Mini board by ALIENTEK

// DFU mode can be accessed by switching BOOT0 DIP ON (towards USB)

#define MICROPY_HW_BOARD_NAME       "ALIENTEK-STM32F407"
#define MICROPY_HW_MCU_NAME         "STM32F407ZGT6"
#define MICROPY_HW_FLASH_FS_LABEL   "ALIENTEK_STM32F407"

// 1 = use internal flash (1 MByte)
// 0 = use onboard SPI flash (16 MByte) Winbond W25Q128
...
// AT24C02 EEPROM on I2C1 0x50-0x53
// IIC_SCL,PB8
// IIC_SDA,PB9
...
// LEDs
#define MICROPY_HW_LED1         (pin_F9)    // red, DS0/LED0
#define MICROPY_HW_LED2         (pin_F10)   // green, DS1/LED1
#define MICROPY_HW_LED_ON(pin)  (mp_hal_pin_low(pin))
#define MICROPY_HW_LED_OFF(pin) (mp_hal_pin_high(pin))
#define MICROPY_HW_LED1_PWM         { TIM14, 14, TIM_CHANNEL_1, GPIO_AF9_TIM14 }


// USRSW has no pullup or pulldown, and pressing the switch makes the input go hight
...
// W25Q128 SPI Flash = 128 Mbit (16 MByte)
...
#define MICROPY_BOARD_EARLY_INIT    F407ZG_board_early_init
void F407ZG_board_early_init(void);
